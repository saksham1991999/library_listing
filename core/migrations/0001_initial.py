# Generated by Django 2.2 on 2020-05-12 22:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('past_record_of_students', models.TextField(blank=True, max_length=500, null=True)),
                ('fb_url', models.CharField(blank=True, max_length=200, null=True)),
                ('insta', models.CharField(blank=True, max_length=100, null=True)),
                ('google_map', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('refund_policy', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=3)),
                ...
                ('opening_days', models.ManyToManyField(to='core.weekday')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('payment_methods', models.ManyToManyField(to='core.payment_methods')),
            ],
            options={
